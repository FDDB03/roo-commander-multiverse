...
export const createDirectoryTool = {
    ...
    description: "Create a new directory or ensure a directory exists in the workspace filesystem. " +
    ...
    inputSchema: CreateDirectoryJsonSchema, // Cast as any if needed
