...
// --- MCP Server Setup ---
const server = new Server({ name: "vertex-ai-mcp-server", version: "0.5.0" }, { capabilities: { tools: {} } });
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        if (toolName === "save_generate_project_guidelines") {
            ...
            const generatedContent = await callGenerativeAI(initialContents, toolsForApi
            // Config args removed
            );
            ...
            const responseText = await callGenerativeAI(initialContents, toolsForApi
